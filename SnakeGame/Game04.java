...
//			}
    ...
    private static final String fileName = "SnakeGameResources/Record/Game04.txt";
    private VBox rightPane=new VBox();
	Game04(SettingsData settDataInput) {
		try { // 讀檔
	...
	private void showGG() {
		...
		GGbtn[0].setOnMouseClicked(e->{
			stage.close();
			Game04 Newgm =new Game04(settData);
			Newgm.show();
		});
