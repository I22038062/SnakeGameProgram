...
public class Game03 {
	...
	class FoodWall extends Pane{
		...
		public void change(Food food){
			...
			if((food.getPosition()[0]==0||food.getPosition()[0]==19)&&(food.getPosition()[1]==0||food.getPosition()[1]==19)) {
				edge_judge=true;
			}
			else if((food.getPosition()[0]==0||food.getPosition()[0]==19)||(food.getPosition()[1]==0||food.getPosition()[1]==19)) {
				border_judge=true;
				edge_judge=false;
			}
			...
			if(!(border_judge||edge_judge)) {				
				...
				else if(food.getPosition()[0]==19&&food.getPosition()[1]==0) {
					int[][] near={{-1,0},{0,1}};
					shuffleArray(near);
					foodwall_arr.clear();
					int[] food_position=food.getPosition();
				...
				else if(food.getPosition()[0]==0&&food.getPosition()[1]==19) {
					int[][] near={{1,0},{0,-1}};
					shuffleArray(near);
					foodwall_arr.clear();
					int[] food_position=food.getPosition();
				...
				else if(food.getPosition()[0]==19&&food.getPosition()[1]==19) {
					int[][] near={{-1,0},{0,-1}};
					shuffleArray(near);
					foodwall_arr.clear();
					int[] food_position=food.getPosition();
    ...
    private static final String fileName = "SnakeGameResources/Record/Game03.txt";
    private VBox rightPane=new VBox();
	Game03(SettingsData settDataInput) {
		try { // 讀檔
	...
	private void showGG() {
		...
		GGbtn[0].setOnMouseClicked(e->{
			stage.close();
			Game03 Newgm=new Game03(settData);
			Newgm.show();
		});
