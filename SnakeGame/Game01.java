...
//			position[1]=block-6;
    ...
    private static final String fileName = "SnakeGameResources/Record/Game01.txt";
    private VBox rightPane=new VBox();
	Game01(SettingsData settDataInput) {
		try { // 讀檔
	...
	private void showGG() {
		...
		GGbtn[0].setOnMouseClicked(e->{
			stage.close();
			Game01 Newgm=new Game01(settData);
			Newgm.show();
		});
