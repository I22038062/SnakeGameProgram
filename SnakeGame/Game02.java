...
//			for(int i=0;i<5;i++) {			
    ...
    private static final String fileName = "SnakeGameResources/Record/Game02.txt";
    private VBox rightPane=new VBox();
	Game02(SettingsData settDataInput) {
		try { // 讀檔
	...
	private void showGG() {
		...
		GGbtn[0].setOnMouseClicked(e->{
			stage.close();
			Game02 Newgm=new Game02(settData);
			Newgm.show();
		});
