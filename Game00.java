...
//			Random random = new Random();
    ...
    private static final String fileName = "SnakeGameResources/Record/Game00.txt";
    private VBox rightPane=new VBox();
    
	Game00(SettingsData settDataInput) {
		try { // 讀檔
	...
	private void showGG() {
		...
		GGbtn[0].setOnMouseClicked(e->{
			stage.close();
			Game00 NewGame=new Game00(settData);
			NewGame.show();
		});
