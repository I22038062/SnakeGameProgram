...
public class Game10 {
    ...
    private static final String fileName = "SnakeGameResources/Record/Game10.txt";
    private VBox rightPane=new VBox();
    Game10(SettingsData settDataInput) {
    	try { // 讀檔
	...
	private void showGG() {
		...
		GGbtn[0].setOnMouseClicked(e->{
			stage.close();
			Game10 NewGame=new Game10(settData);
			NewGame.show();
		});
